        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tagline = table.Column<string>(type: "varchar(MAX)", nullable: false),
                    Budget = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Revenue = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ImdbId = table.Column<string>(type: "varchar(2084)", nullable: false),
                    TmdbId = table.Column<string>(type: "varchar(2084)", nullable: false),
                    ...
                    UpdatedBy = table.Column<string>(type: "varchar(MAX)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CrewMovie", x => new { x.CrewId, x.MoviesId });
                    table.ForeignKey(
